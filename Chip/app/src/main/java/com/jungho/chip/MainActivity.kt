    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        chip1.setOnClickListener {
            ...
            when(chipGroup1.checkedChipId) {
                R.id.chip6 -> {
                    textView.append("그룹 내의 첫번째 Chip이 선택되어 있습니다.\n")
                }
                R.id.chip7 -> {
                    textView.append("그룹 내의 두번째 Chip이 선택되어 있습니다.\n")
                }
                R.id.chip8 -> {
                    textView.append("그룹 내의 세번째 Chip이 선택되어 있습니다.\n")
                }
            }
        }
        ...
        chip5.setOnCheckedChangeListener { view, isChecked ->
            if(isChecked)
                textView.text = "네번째 Chip이 체크 되었습니다."
            else
